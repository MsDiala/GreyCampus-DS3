...
SELECT bookings.starttime,facilities.name FROM cd.facilities INNER JOIN cd.bookings on cd.facilities.facid = cd.bookings.facid
WHERE facilities.name LIKE '%Tennis Court%' AND bookings.starttime BETWEEN '2012-09-21 00:00:00' and '2012-09-21 23:59:59'
ORDER BY starttime ;

-- 14.How can you produce a list of the start times for bookings by members named 'David Farrell'?
SELECT bookings.starttime FROM cd.bookings INNER JOIN cd.members 
